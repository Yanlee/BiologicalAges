...
skin <- read.csv("G:/Æ¤·ô/2017SkinPercentile.csv")
...
trainData <- read.csv("G:/CelFULL/BioAgeBGE_matched.csv", header=T)
celfull <- read.csv("G:/CelFULL/Hebe.csv", header=T)

#B1_celfull <- read.csv("G:/CelFULL/Hebe_batch1.csv", header=T)
#celfull<- B1_celfull
#vascular_age <- read.csv("G:/CelFULL/vascular.results.results.csv", header=T)
...
write.table(hebe_results, file="G:/CelFULL/CardiovascularAge.txt")
