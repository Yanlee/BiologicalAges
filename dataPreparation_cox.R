...
library(dplyr)
source("G:/BioAge/bin/kdm_calc.R") 
...
bp <- read.csv("G:/BioAge/NHANES/1999_2020/all.DPX.csv", header=T)
...
CHOL99 <- read.xport("G:/BioAge/NHANES/Cholesterol/LAB13_99_00.XPT")
CHOL01 <- read.xport("G:/BioAge/NHANES/Cholesterol/L13_B_01_02.XPT")
CHOL03 <- read.xport("G:/BioAge/NHANES/Cholesterol/L13_C_03_04.XPT")
CHOL05 <- read.xport("G:/BioAge/NHANES/Cholesterol/TCHOL_D_05_06.XPT")
CHOL07 <- read.xport("G:/BioAge/NHANES/Cholesterol/TCHOL_E_07_08.XPT")
CHOL09 <- read.xport("G:/BioAge/NHANES/Cholesterol/TCHOL_F_09_10.XPT")
CHOL11 <- read.xport("G:/BioAge/NHANES/Cholesterol/TCHOL_G_11_12.XPT")
CHOL13 <- read.xport("G:/BioAge/NHANES/Cholesterol/TCHOL_H_13_14.XPT")
CHOL15 <- read.xport("G:/BioAge/NHANES/Cholesterol/TCHOL_I_15_16.XPT")
CHOL17 <- read.xport("G:/BioAge/NHANES/Cholesterol/P_TCHOL_17_20.XPT")
...
data <- read.csv("G:/BioAge/StaffFamilyData/StaffFamilyManCardio.csv", header=T)
